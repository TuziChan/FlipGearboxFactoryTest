...
Column {
    ...
    Rectangle {
        ...
        color: Qt.tint(root.theme.cardColor, Qt.rgba(root.theme.stroke.r, root.theme.stroke.g, root.theme.stroke.b, 0.15))
        ...
        Rectangle {
            ...
            visible: triggerHover.hovered && !popup.visible
        }
    ...
    Popup {
        ...
        contentItem: Column {
            ...
            Rectangle {
                ...
                TapHandler {
                    onTapped: listView.contentY = Math.max(0, listView.contentY - 48)
                }
            }
            ...
            ListView {
                ...
                delegate: Rectangle {
                    ...
                    radius: root.theme.radiusSmall
                    color: mouse.hovered || itemDelegate.highlighted ? Qt.rgba(root.theme.accent.r, root.theme.accent.g, root.theme.accent.b, 0.1) : "transparent"
