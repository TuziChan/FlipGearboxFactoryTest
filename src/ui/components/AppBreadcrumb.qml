            ...
            delegate: Row {
                ...
                Item {
                        ...
                        Text {
                            ...
                            color: root.itemCurrentAt(crumbRow.index)
                                   ? root.theme.textPrimary
                                     : crumbArea.containsMouse && crumbArea.enabled
                                       ? root.theme.textPrimary
                    ...
                    MouseArea {
                        id: crumbArea
                        anchors.fill: parent
                        enabled: !root.itemCurrentAt(crumbRow.index) && !root.itemElidedAt(crumbRow.index) && root.itemEnabledAt(crumbRow.index)
                        hoverEnabled: true
                        cursorShape: enabled ? Qt.PointingHandCursor : Qt.ArrowCursor
                        onClicked: root.crumbTriggered(crumbRow.index, root.itemValueAt(crumbRow.index))
                    }
                }
