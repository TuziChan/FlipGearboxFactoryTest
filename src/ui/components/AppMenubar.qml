    ...
    RowLayout {
        ...
        Repeater {
            ...
            delegate: Rectangle {
                ...
                readonly property bool hovered: triggerMouse.containsMouse
                ...
                MouseArea {
                    ...
                    hoverEnabled: true
                    onClicked: {
                        if (triggerItem.active)
                            root.closeMenus()
                        else
                            root.openMenu(triggerItem.index)
                    }
                    onEntered: {
                        if (popup.visible && root.currentMenuIndex !== triggerItem.index)
                            root.openMenu(triggerItem.index)
                    }
                }
            }
